...
import team.idealstate.hyper.rpc.api.JarUtils;
...
import team.idealstate.minecraft.contentpublisher.common.YamlUtils;
...
final class ServiceHelper {
    ...
    private void load(@NotNull ClassLoader classLoader) {
        ...
        file = JarUtils.copy(AssetUtils.asset("/public"), AssetUtils.dataDirectory());
    ...
    public void startup() {
        ...
        try {
            if (serviceManager == null && watchdog == null) {
                ...
                ClientStarter starter = new ClientStarter(address, key, serviceManager, nThreads);
