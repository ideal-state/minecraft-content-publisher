...
/**
 * <p>ContentPublishService</p>
 *
 * <p>创建于 2024/2/9 15:57</p>
 *
 * @author ketikai
 * @version 1.0.0
 * @since 1.0.0
 */
@RemoteService
@Implementation("team.idealstate.minecraft.contentpublisher.spigot.service.ContentPublishServiceImpl")
public interface ContentPublishService {

    void publish(@NotNull String id, @NotNull String path, byte @NotNull [] content);
}
